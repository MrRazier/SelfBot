...
client._tokenLogin("EmudSWcat4UN2gVP0xd1.3mSSZdsWDr/Pkb9UXr/gKq.MnUcLy7g6tCQ0HjpEq7b7FSMPEW9SyzsBN8pRZPODiY=")
...
#-----------------------------------------------------------------------------------------------------------------------------------
		...
		if msg.text == "spam":
		    ...
		    sendMessage(msg.to,"adalah")
    		    sendMessage(msg.to,"Farzain zFz")
		    sendMessage(msg.to,"")
		if msg.text == "buka":
                    group = client.getGroup(msg.to)
